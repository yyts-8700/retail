    ...
    <div class='body'>
      <div class='table-title'>
        ...
        <div class='button-wrapper'>
          ...
          <el-button class='addProp' @click='$router.push("/goods/type/addProp")'>添加属性</el-button>    
        </div>
      </div>
      <el-table @selection-change='selectionChange' :data='tableData' :header-cell-style="headerStyle" :cell-style="tdStyle" ref='table' class='prop-list'>
...
<style>
.body .prop-list .el-table__empty-block{
